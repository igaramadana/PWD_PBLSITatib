                                ...
                                <table class="table table-bordered text-center">
                                    ...
                                    <tbody>
                                            ...
                                            foreach ($pelanggaranList as $pelanggaran) : ?>
                                                <tr>
                                                    ...
                                                    <td class="text-center"><?php echo htmlspecialchars($pelanggaran['NamaMahasiswa']); ?></td>
                                                        ...
                                                        <?php if (!empty($pelanggaran['Bukti'])): ?>
                                                            <a href="<?php echo htmlspecialchars($pelanggaran['Bukti']); ?>" target="_blank">Lihat Bukti</a>
                                                        <?php else: ?>
                                                            Tidak ada bukti
                                                        <?php endif; ?>
                                                    </td>
                                        ...
                                        <?php else : ?>
                                            <!-- Jika data kosong -->
                                            <tr>
                                                <td colspan="5" class="text-center">Tidak ada data pelanggaran yang ditemukan.</td>
                                            </tr>
                                        <?php endif; ?>
                                    </tbody>
                                </table>
