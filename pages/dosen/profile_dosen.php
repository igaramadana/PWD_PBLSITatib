...
if (sqlsrv_has_rows($stmt)) {
    ...
    $_SESSION['fotoProfil'] = $dosen['ProfilDosen'];
} else {
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="card mb-4">
                            ...
                            <div class="card-body text-center">
                                ...
                                <h5 class="my-3"><?php echo $dosen['Nama']; ?></h5>
                    ...
                    <div class="col-lg-8">
                        <div class="card mb-4">
                            <div class="card-header">
                                <h4 class="card-title">Informasi Dosen</h4>
                            </div>
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-9">
                                        <p class="text-muted mb-0"><?php echo $dosen['NIP']; ?></p>
                                    </div>
                                </div>
                                <hr>
                                <div class="row">
                                    ...
                                    <div class="col-sm-9">
                                        <p class="text-muted mb-0"><?php echo $dosen['Nama']; ?></p>
                                    </div>
                                </div>
                                <hr>
                                <div class="row">
                                    ...
                                    <div class="col-sm-9">
                                        <p class="text-muted mb-0"><?php echo $dosen['JKDosen']; ?></p>
                                    </div>
                                </div>
                                <hr>
                                <div class="row">
                                    ...
                                    <div class="col-sm-9">
                                        <p class="text-muted mb-0"><?php echo $dosen['PhoneDosen']; ?></p>
                                    </div>
                                </div>
                                <hr>
                                <div class="row">
                                    ...
                                    <div class="col-sm-9">
                                        <p class="text-muted mb-0"><?php echo $dosen['EmailDosen']; ?></p>
                                    </div>
                                </div>
                                <hr>
                            </div>
