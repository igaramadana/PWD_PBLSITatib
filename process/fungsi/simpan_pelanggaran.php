...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (move_uploaded_file($_FILES['bukti']['tmp_name'], $uploadFile)) {
        ...
        // Ambil NamaSanksi berdasarkan PelanggaranID
        ...
        if ($stmt === false) {
            ...
            ";
                ...
                // Kirim email
                if ($mail->send()) {
                    echo "<script>alert('Pelanggaran berhasil disimpan dan email berhasil dikirim.'); window.location.href='../../pages/admin/input_pelanggaran.php';</script>";
                } else {
                    echo "<script>alert('Pelanggaran berhasil disimpan, tetapi gagal mengirim email.'); window.location.href='../../pages/admin/input_pelanggaran.php';</script>";
                }
            } catch (Exception $e) {
                echo "<script>alert('Terjadi kesalahan saat mengirim email: " . $mail->ErrorInfo . "'); window.location.href='../../pages/admin/input_pelanggaran.php';</script>";
            }
        }
